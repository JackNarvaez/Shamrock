...
#define NODE_UPDATE_DERIVS_VARYING_ALPHA_AV_EDGES_MHD(X_RO, X_RW)                                  \
    /* scalars */                                                                                  \
    ...
    X_RO(shamrock::solvergraph::ScalarEdge<Tscal>, sigma_mhd)                                      \
    X_RO(shamrock::solvergraph::ScalarEdge<Tscal>, mu_0)                                           \
                                                                                                   \
    /* counts */                                                                                   \
    ...
    X_RO(shamrock::solvergraph::IFieldSpan<Tvec>, B_on_rho)                                        \
    X_RO(shamrock::solvergraph::IFieldSpan<Tscal>, psi_on_ch)                                      \
                                                                                                   \
    /* neigh */                                                                                    \
...
namespace shammodels::sph::modules {
    ...
    class NodeUpdateDerivsVaryingAlphaAV_MHD : public shamrock::solvergraph::INode {
        ...
        public:
        NodeUpdateDerivsVaryingAlphaAV_MHD() {}

        EXPAND_NODE_EDGES(NODE_UPDATE_DERIVS_VARYING_ALPHA_AV_EDGES_MHD)

        void _impl_evaluate_internal();

        inline virtual std::string _impl_get_label() const { return "UpdateDerivsVaryingAlphaAV_MHD"; };
